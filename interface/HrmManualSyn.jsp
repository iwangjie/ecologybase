...
<HTML>
	...
	<%
		...
		if(!Util.null2String(hrmSynDAO.getIsuselhr()).equals("1")||Util.null2String(hrmSynDAO.getHrmethod()).equals("2"))
		{
			cansync = false;
		%>
		<script language="javascript">
		top.Dialog.alert("<%=SystemEnv.getHtmlLabelName(32326 ,user.getLanguage())%>!");//未启用HR同步手动同步
		//return;
		</script>
		<%
			//return;
